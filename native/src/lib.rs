...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            endpoint::endpoint_person_protocol_event_next,
            ...
            endpoint::endpoint_conn_type,
            endpoint::endpoint_latency,
            endpoint::person_protocol_event_next::endpoint_person_protocol_event_next_as_request_remote_id,
            endpoint::person_protocol_event_next::endpoint_person_protocol_event_next_as_request_accept,
            endpoint::person_protocol_event_next::endpoint_person_protocol_event_next_as_request_reject,
            endpoint::person_protocol_event_next::endpoint_person_protocol_event_next_as_chat_request_accept,
